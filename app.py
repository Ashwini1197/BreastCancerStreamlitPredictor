...
def get_scatter_plots(data):
    fig = px.scatter_matrix(data, dimensions=['radius_mean', 'texture_mean', 'perimeter_mean', 'area_mean'],
                           color='diagnosis')
    fig.update_layout(
...
def get_violin_plot(data):
    fig = px.violin(data, x="diagnosis", y='radius_mean', color="diagnosis", box=True)
    fig.update_layout(
...
def main():
    ...
    with col2:
        ...
        scatter_plots = get_scatter_plots(data)
